...
- (void)setupFilter {
    ...
    [self.intensityFilter addTarget:self.grayscaleFilter];
    filterGroup.initialFilters = [NSArray arrayWithObjects:self.intensityFilter, nil];
    filterGroup.terminalFilter = self.grayscaleFilter;
