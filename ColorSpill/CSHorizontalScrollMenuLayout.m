//
//  CSHorizontalScrollMenuLayout.m
//  ColorSpill
//
...
static NSString *const CSMenuItemCellLayout = @"CSMenuItemCellLayout";
static NSString *const CSMenuItemTitleLayout = @"CSMenuItemTitleLayout";

@interface CSHorizontalScrollMenuLayout ()

@property (strong, nonatomic) NSMutableDictionary *layoutInfo;

@end

@implementation CSHorizontalScrollMenuLayout
...
- (void)prepareLayout {
    ...
    self.layoutInfo[CSMenuItemCellLayout] = cellViewLayouts;
    self.layoutInfo[CSMenuItemTitleLayout] = titleViewLayouts;
}
...
- (UICollectionViewLayoutAttributes *)layoutAttributesForItemAtIndexPath:(NSIndexPath *)indexPath {
    return self.layoutInfo[CSMenuItemCellLayout][indexPath];
}

- (UICollectionViewLayoutAttributes *)layoutAttributesForSupplementaryViewOfKind:(NSString *)kind atIndexPath:(NSIndexPath *)indexPath {
    return self.layoutInfo[CSMenuItemTitleLayout][indexPath];
}
